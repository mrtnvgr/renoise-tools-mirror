...
xRulesUI.ASPECT_ITEMS = cLib.stringify_table(xRule.ASPECT)
xRulesUI.ASPECT_DEFAULTS = cLib.stringify_table(xRule.ASPECT_DEFAULTS.CHANNEL)
xRulesUI.ASPECT_DEFAULT_TRACKS = cLib.stringify_table(xRule.ASPECT_DEFAULTS.TRACK_INDEX)
xRulesUI.ASPECT_DEFAULT_INSTRUMENTS = cLib.stringify_table(xRule.ASPECT_DEFAULTS.INSTRUMENT_INDEX)
xRulesUI.ACTION_ITEMS = cLib.stringify_table(xRule.ACTIONS)
