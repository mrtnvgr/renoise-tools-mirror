...
do
  ...
  require (xLib_dir.."xOscPattern")
  require (xLib_dir.."xOscRouter")
  require (xLib_dir.."xValue")
  require (xLib_dir.."xOscValue")
  ...
  function create_note_message(instr,track,note,velocity)
  ...
  assert(xLib.float_compare(rslt[10].arguments[1].value,3.1415926535897932384,10000))
  assert(xLib.float_compare(rslt[10].arguments[2].value,0.123,10000))
  ...
  assert(xLib.float_compare(rslt[11].arguments[1].value,3.14,10000),rslt[11].arguments[1].value)
  assert(xLib.float_compare(rslt[11].arguments[2].value,1.2345,10000),rslt[11].arguments[2].value)
  ...
  assert(xLib.float_compare(rslt[12].arguments[1].value,3.1415926535897932384,10000),rslt[12].arguments[1].value)
  assert(xLib.float_compare(rslt[12].arguments[2].value,5.17,10000),rslt[12].arguments[2].value)
  ...
  assert(xLib.float_compare(rslt[13].arguments[1].value,1.23,10000),rslt[13].arguments[1].value)
  assert(xLib.float_compare(rslt[13].arguments[2].value,2.34,10000),rslt[13].arguments[2].value)
